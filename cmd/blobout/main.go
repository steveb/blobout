...
import (
	...
	"github.com/steveb/blobout/version"
...
var defaultUserAgent = "blobout/" + version.Version
...
// Some small style changes to match blobout were applied, but try to apply any
...
func createApp() (*cobra.Command, *globalOptions) {
	...
	rootCommand := &cobra.Command{
		...
		// (blobout --tls-verify inspect) (causes a warning) and (blobout inspect --tls-verify) (no warning).
	...
	rootCommand.Flags().BoolVarP(&dummyVersion, "version", "v", false, "Version for blobout")
